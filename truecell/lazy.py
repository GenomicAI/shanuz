...
``LazyMatrix`` is the Python analogue, built on the one dependency truecell already
...
==============================
truecell matrices are ``features × cells``, and the operations that dominate at
...
==========================
An :class:`~truecell.assay5.Assay5` layer may hold *any* array-like object, so a
