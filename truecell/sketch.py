...
the output *looks* broken. truecell did exactly this until the sketching tutorial
...
:func:`truecell.project_umap`), and optionally carries the sketch's labels out to
